...
function request(url, type, data, successCb, errorCb, completeCb) {
 ...
 // banner
function requestBanner(data, successCb, errorCb, completeCb) {
  request(api.API_banner, 'GET', data, successCb, errorCb, completeCb);
}
 // 开始答题
function requestStartTest(data, successCb, errorCb, completeCb) {
  request(api.API_start_test, 'GET', data, successCb, errorCb, completeCb);
}
// 最新列表
...
// 题目列表
function requestSubject(data, successCb, errorCb, completeCb) {
  request(api.API_subject, 'GET', data, successCb, errorCb, completeCb);
}
 // 查看结果
function requestResult(data, successCb, errorCb, completeCb) {
  request(api.API_result, 'GET', data, successCb, errorCb, completeCb);
}
 // 参与打卡
...
module.exports = {
  requestBanner: requestBanner,     // banner
  requestStartTest: requestStartTest,      // 开始答题
  requestNewsList: requestNewsList,   // 最新列表
  requestSubject: requestSubject,     //题目列表
  requestResult: requestResult,     //查看结果
